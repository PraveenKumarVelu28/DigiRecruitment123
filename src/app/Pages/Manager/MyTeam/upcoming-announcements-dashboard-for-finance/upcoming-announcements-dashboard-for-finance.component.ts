...
@Component({
  selector: 'app-upcoming-announcements-dashboard-for-finance',
  templateUrl: './upcoming-announcements-dashboard-for-finance.component.html',
  styleUrls: ['./upcoming-announcements-dashboard-for-finance.component.css']
})
export class UpcomingAnnouncementsDashboardForFinanceComponent implements OnInit {
