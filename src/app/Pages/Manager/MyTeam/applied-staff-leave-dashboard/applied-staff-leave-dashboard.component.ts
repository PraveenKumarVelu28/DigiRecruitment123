...
@Component({
  selector: 'app-applied-staff-leave-dashboard',
  templateUrl: './applied-staff-leave-dashboard.component.html',
  styleUrls: ['./applied-staff-leave-dashboard.component.css']
})
export class AppliedStaffLeaveDashboardComponent implements OnInit {
  Search:any;
  ...
  //   
  //   this.DigiOfficeService.ClosedComplaints(this.feedbackID,this.notes).subscribe(res => {
  //     
