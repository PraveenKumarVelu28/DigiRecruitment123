...
@Component({
  selector: 'app-upcoming-announcements-dashboard-for-manager',
  templateUrl: './upcoming-announcements-dashboard-for-manager.component.html',
  styleUrls: ['./upcoming-announcements-dashboard-for-manager.component.css']
})
export class UpcomingAnnouncementsDashboardForManagerComponent implements OnInit {
