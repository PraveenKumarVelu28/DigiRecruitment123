...
@Component({
  selector: 'app-all-expense-for-receptionist',
  templateUrl: './all-expense-for-receptionist.component.html',
  styleUrls: ['./all-expense-for-receptionist.component.css']
})
export class AllExpenseForReceptionistComponent implements OnInit {
