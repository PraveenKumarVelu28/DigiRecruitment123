...
@Component({
  selector: 'app-all-staff-leave-for-admin',
  templateUrl: './all-staff-leave-for-admin.component.html',
  styleUrls: ['./all-staff-leave-for-admin.component.css']
})
export class AllStaffLeaveForAdminComponent implements OnInit {
  Search:any;
  ...
  ngOnInit(): void {
    ...
    this.GetAllStaffLeavesForCEO(this.startdate,this.enddate);
  }
  ...
  public GetAllStaffLeavesForCEO(Sdate,Edate) {
    ...
    this.DigiOfficeService.GetAllStaffLeavesForCEO(Sdate,Edate).subscribe(res => {
