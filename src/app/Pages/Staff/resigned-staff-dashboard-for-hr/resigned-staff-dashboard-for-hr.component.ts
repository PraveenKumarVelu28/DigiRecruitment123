...
@Component({
  selector: 'app-resigned-staff-dashboard-for-hr',
  templateUrl: './resigned-staff-dashboard-for-hr.component.html',
  styleUrls: ['./resigned-staff-dashboard-for-hr.component.css']
})
export class ResignedStaffDashboardForHrComponent implements OnInit {
