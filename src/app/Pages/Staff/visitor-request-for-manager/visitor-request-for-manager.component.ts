...
@Component({
  selector: 'app-visitor-request-for-manager',
  templateUrl: './visitor-request-for-manager.component.html',
  styleUrls: ['./visitor-request-for-manager.component.css']
})
export class VisitorRequestForManagerComponent implements OnInit {
