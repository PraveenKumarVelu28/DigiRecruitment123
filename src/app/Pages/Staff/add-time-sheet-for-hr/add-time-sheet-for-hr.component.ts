...
@Component({
  selector: 'app-add-time-sheet-for-hr',
  templateUrl: './add-time-sheet-for-hr.component.html',
  styleUrls: ['./add-time-sheet-for-hr.component.css']
})
export class AddTimeSheetForHRComponent implements OnInit {
  buildingList: any[];
  buildingID: any;
  floorList: any[];
  projectList: any[];
