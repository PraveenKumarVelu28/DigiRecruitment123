...
@Component({
  selector: 'app-time-sheets-for-manager',
  templateUrl: './time-sheets-for-manager.component.html',
  styleUrls: ['./time-sheets-for-manager.component.css']
})
export class TimeSheetsForManagerComponent implements OnInit {
  search: any;
