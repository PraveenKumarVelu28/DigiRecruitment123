...
@Component({
  selector: 'app-all-visitor-requestfor-admin',
  templateUrl: './all-visitor-requestfor-admin.component.html',
  styleUrls: ['./all-visitor-requestfor-admin.component.css']
})
export class AllVisitorRequestforAdminComponent implements OnInit {
