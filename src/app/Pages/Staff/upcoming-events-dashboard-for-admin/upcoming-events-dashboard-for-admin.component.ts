...
@Component({
  selector: 'app-upcoming-events-dashboard-for-admin',
  templateUrl: './upcoming-events-dashboard-for-admin.component.html',
  styleUrls: ['./upcoming-events-dashboard-for-admin.component.css']
})
export class UpcomingEventsDashboardForAdminComponent implements OnInit {
  value: any;
  eventList: any[];
