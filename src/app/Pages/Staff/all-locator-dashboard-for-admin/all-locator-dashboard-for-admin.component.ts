...
@Component({
  selector: 'app-all-locator-dashboard-for-admin',
  templateUrl: './all-locator-dashboard-for-admin.component.html',
  styleUrls: ['./all-locator-dashboard-for-admin.component.css']
})
export class AllLocatorDashboardForAdminComponent implements OnInit {
