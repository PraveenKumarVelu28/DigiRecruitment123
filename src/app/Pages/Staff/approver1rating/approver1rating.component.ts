...
@Component({
  selector: 'app-approver1rating',
  templateUrl: './approver1rating.component.html',
  styleUrls: ['./approver1rating.component.css']
})
export class Approver1ratingComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.fmsservice.GetConductappraisalStaffList().subscribe(
      res => {
        ...
        this.Approver2 = this.StaffAppraisalList[0].approver2
