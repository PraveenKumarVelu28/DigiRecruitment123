...
@Component({
  selector: 'app-assigned-task-by-ceo',
  templateUrl: './assigned-task-by-ceo.component.html',
  styleUrls: ['./assigned-task-by-ceo.component.css']
})
export class AssignedTaskByCEOComponent implements OnInit {
   ...
   public InsertDetails() {
    ...
    this.DigiOfficeService.InsertTasks(Entity).subscribe(
      data => {
        ...
        location.href = "#/AssignedTaskDashboard";
      }, error => {
      }
    )
  }
