...
@Component({
  selector: 'app-up-coming-events-dashboard-for-finance',
  templateUrl: './up-coming-events-dashboard-for-finance.component.html',
  styleUrls: ['./up-coming-events-dashboard-for-finance.component.css']
})
export class UpComingEventsDashboardForFinanceComponent implements OnInit {
