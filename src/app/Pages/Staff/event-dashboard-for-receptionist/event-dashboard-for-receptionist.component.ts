...
@Component({
  selector: 'app-event-dashboard-for-receptionist',
  templateUrl: './event-dashboard-for-receptionist.component.html',
  styleUrls: ['./event-dashboard-for-receptionist.component.css']
})
export class EventDashboardForReceptionistComponent implements OnInit {
