...
@Component({
  selector: 'app-completed-events-dashboard-for-admin',
  templateUrl: './completed-events-dashboard-for-admin.component.html',
  styleUrls: ['./completed-events-dashboard-for-admin.component.css']
})
export class CompletedEventsDashboardForAdminComponent implements OnInit {
  search:any;
