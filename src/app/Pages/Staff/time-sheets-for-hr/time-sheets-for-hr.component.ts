...
@Component({
  selector: 'app-time-sheets-for-hr',
  templateUrl: './time-sheets-for-hr.component.html',
  styleUrls: ['./time-sheets-for-hr.component.css']
})
export class TimeSheetsForHrComponent implements OnInit {
  search: any;
