...
@Component({
  selector: 'app-visitor-request-dashboard-for-manager',
  templateUrl: './visitor-request-dashboard-for-manager.component.html',
  styleUrls: ['./visitor-request-dashboard-for-manager.component.css']
})
export class VisitorRequestDashboardForManagerComponent implements OnInit {
