...
@Component({
  selector: 'app-announcements-dashboard-for-hr',
  templateUrl: './announcements-dashboard-for-hr.component.html',
  styleUrls: ['./announcements-dashboard-for-hr.component.css']
})
export class AnnouncementsDashboardForHRComponent implements OnInit {
