...
@Component({
  selector: 'app-rasied-expense-for-finance-dashboard',
  templateUrl: './rasied-expense-for-finance-dashboard.component.html',
  styleUrls: ['./rasied-expense-for-finance-dashboard.component.css']
})
export class RasiedExpenseForFinanceDashboardComponent implements OnInit {
