...
@Component({
  selector: 'app-assigned-task-for-tldashboard',
  templateUrl: './assigned-task-for-tldashboard.component.html',
  styleUrls: ['./assigned-task-for-tldashboard.component.css']
})
export class AssignedTaskForTLDashboardComponent implements OnInit {
