...
@Component({
  selector: 'app-approver2ratingpage',
  templateUrl: './approver2ratingpage.component.html',
  styleUrls: ['./approver2ratingpage.component.css']
})
export class Approver2ratingpageComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.fmsservice.GetConductappraisalStaffList().subscribe(
      res => {
        ...
        this.Approver3 = this.StaffAppraisalList[0].Approver3
