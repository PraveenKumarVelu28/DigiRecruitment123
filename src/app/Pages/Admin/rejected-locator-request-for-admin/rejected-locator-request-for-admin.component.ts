...
@Component({
  selector: 'app-rejected-locator-request-for-admin',
  templateUrl: './rejected-locator-request-for-admin.component.html',
  styleUrls: ['./rejected-locator-request-for-admin.component.css']
})
export class RejectedLocatorRequestForAdminComponent implements OnInit {
  Search: any;
  UserID: any;
  SDate: any;
  EDate: any;
