...
@Component({
  selector: 'app-approved-locator-request-for-admin',
  templateUrl: './approved-locator-request-for-admin.component.html',
  styleUrls: ['./approved-locator-request-for-admin.component.css']
})
export class ApprovedLocatorRequestForAdminComponent implements OnInit {
  Search: any;
  UserID: any;
  SDate: any;
  EDate: any;
